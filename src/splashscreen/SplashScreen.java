...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    doTask("Conexion Exitosa ...", 10);
                    doTask("Transfiriendo Datos ...", 20);
                    doTask("Cargando Datos ...", 30);
                    doTask("Conectando a Base de Datos ...", 40);
                    ConexionBD db = new ConexionBD();
                    Connection conn = db.getConnection();
                    db.closeConnection();
                    doTask("Cargando Componentes ...", 50);
                    doTask("Cargando Tablas ...", 60);
                    doTask("Recopilando Informacion ...", 70);
                    doTask("Terminando Procesos ...", 80);
                    doTask("Procesos Casi Terminados ...", 90);
                    doTask("Procesos Terminados ...", 100);
                    doTask("Listo ...", 100);
                    dispose();
